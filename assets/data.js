...
const MEMBERSHIPS = {
  nj: {
    ...
    rows: [
      ...
      { key: 'cricket',   label: 'Cricket discounts',      sub: 'open play / box / leagues' },
    ...
    tiers: [
      { id: 'nj-open', name: 'Open Play Elite', tagline: "Best for regular open-play bookings",
        priceMo: 35, priceQ: null, featured: true, limitedOffer: false, cta: 'Join Open Play Elite',
        cells: { fullCourt: '$54 / $39.60 (10% off)', openPlay: '$14 / $10.50 (30% off)', cricket: '—', advance: '21 days', coaching: '$20 off' },
      ...
      { id: 'nj-court', name: 'Full Court Elite', tagline: 'Best for regular full-court bookings',
        priceMo: 59, priceQ: null, featured: false, limitedOffer: false, cta: 'Join Full Court Elite',
        cells: { fullCourt: '$45 / $33 (25% off)', openPlay: '$18 / $13.50 (10% off)', cricket: '—', advance: '21 days', coaching: '$25 off' },
      ...
      { id: 'nj-resident', name: 'Resident Membership', tagline: 'For residents of partner apartment buildings',
        priceMo: 99, priceQ: null, featured: false, limitedOffer: false, cta: 'Join Resident',
        cells: { fullCourt: '$54 / $39.60 (10% off)', openPlay: '$20 / $15 + 4 free/mo (Summit)', cricket: '—', advance: '21 days', coaching: '$25 off' },
        perks: ['4 free open plays / month at Summit Ave (dedicated hours)', '10% off full-court bookings', '$25 off coaching packages', '$50 off event rentals', '21-day advance booking', 'Verified residents of partner buildings only'] },
      { id: 'nj-cricket', name: 'Cricket Elite', tagline: 'For regular cricket open play and leagues',
        priceMo: 29, priceQ: null, featured: false, limitedOffer: false, cta: 'Join Cricket Elite',
        cells: { fullCourt: '—', openPlay: '—', cricket: '50% off open play · 10% off box & leagues', advance: '21 days', coaching: '—' },
        perks: ['50% off all cricket open plays', '10% off full-box bookings & cricket leagues', '21-day advance booking', 'Usable across all Kotofit cricket facilities', 'Free cancellation any time'] },
    ],
  },
  lic: {
    ...
    tiers: [
      { id: 'lic-silver', name: 'Silver', tagline: 'Best for regular open-play bookings',
        priceMo: 49, standardPriceMo: 59, priceQ: 129, standardPriceQ: 159, featured: true, limitedOffer: true, cta: 'Join Silver',
      ...
      { id: 'lic-gold', name: 'Gold', tagline: 'Best for regular private-court bookings',
        priceMo: 139, standardPriceMo: 149, priceQ: 389, standardPriceQ: 419, featured: false, limitedOffer: true, cta: 'Join Gold',
      ...
      { id: 'lic-plat', name: 'Platinum', tagline: 'Dedicated weekly pre-reserved courts at 30% off',
        priceMo: null, priceQ: 699, standardPriceQ: 749, featured: false, limitedOffer: true, cta: 'Join Platinum',
...
const FAQS = {
  memberships: [
    ...
    { q: 'Should I pay monthly or quarterly?', a: 'Long Island City paid tiers (Silver, Gold, Platinum) offer monthly or quarterly billing — quarterly is roughly one month free per quarter. New Jersey tiers are monthly only. Pick monthly for flexibility to cancel sooner; pick quarterly if you know you will be playing consistently. Platinum is quarterly only.' },
    { q: 'What is the cancellation policy?', a: 'All membership tiers can cancel auto-renewal at any time at no charge — your access continues through the end of the period you already paid for.' },
...
FAQS.booking = [
  ...
  { q: 'Do I have to be a member to play?', a: 'No — non-members can book courts and open plays at standard pay-per-play rates with up to 14-day advance booking. Memberships unlock discounts, longer booking windows, and other perks.' },
